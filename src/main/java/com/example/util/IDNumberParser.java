...
public class IDNumberParser
{
    ...
    public IDNumberData parse(String idNumber){
        if (idNumber.length() != 13) {
            throw new IllegalArgumentException("ID Length invalid: ZA ID Number must be 13 digits long");
        }
     ...
     * The problem with parsing this is I dont know if 19 means 2019 or 1919.
